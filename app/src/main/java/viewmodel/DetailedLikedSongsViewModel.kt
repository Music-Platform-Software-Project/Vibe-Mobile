...
import view.DetailedLikedSongs
import view.DetailedPlaylist
import view.PlaylistDetailRecViewAdapter


class DetailedLikedSongsViewModel() : ViewModel() {

    private lateinit var ctx: DetailedLikedSongs

    fun setContext(ctx: DetailedLikedSongs) {
        this.ctx = ctx
    }
